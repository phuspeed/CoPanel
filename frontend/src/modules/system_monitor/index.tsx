...
export default function SystemMonitorDashboard() {
  ...
  const t = {
    en: {
      ...
      desc: 'Track resource history, monitor running processes, and perform advanced PM2 lifecycles.'
    },
    vi: {
      title: 'Giám sát Tài nguyên Hệ thống',
      desc: 'Theo dõi lịch sử tài nguyên, quy trình đang chạy và quản lý vòng đời ứng dụng PM2.'
    }
  };
